...
const About = () => {
  return <div className="py-16 bg-gray-100 dark:bg-gray-900">
    {/*----Section Heading----*/}
        <SectionHeading 
        title_1="About" 
        title_2="Me" 
            ...
            <div 
               ...
               data-aos-anchor-placement="top-center" className="space-y-6">
                ...
                <p className="text-muted-foreground leading-relaxed">
                    I'm a MERN stack developer with over 0.5 years of experience building
                ...
                <p className="text-muted-foreground leading-relaxed">
                    Beyond coding, I'm passionate about contributing to open-source projects
                    and collaborating with the developer community. I regularly explore 
                    GitHub projects, fix issues, and improve features to help make 
                    software better for everyone. I believe open source is a great way 
                    to learn from others, share knowledge, and grow as a developer 
                    while building tools that benefit the global community.
                </p>
                {/*------Highlights---------*/}
                    ...
                    {highlights.map((item)=>{
                        return (
                            ...
                            >
                                ...
                                justify-center ">
                                <item.icon className="w-4 h-8 text-blue-500"/>
                                </div>
