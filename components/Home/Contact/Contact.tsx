  ...
  return (
    <div className="py-16 bg-gray-100 dark:bg-gray-950">
      <SectionHeading
        title_1="Get In"
        title_2="Touch"
        description="Have a project on mind or just want to say hi? I'd love to hear from you."
      />
              ...
              {contactInfo.map((item) => {
                return (
                  <a
                    ...
                    key={item.label}
                    target="_blank"
                    className="flex items-center gap-4 p-4 bg-white dark:bg-gray-800 shadow-md
                    rounded-xl hover:scale-105 transition-all duration-300 group"
                  >
                    <div
                      className="w-12 h-12 rounded-lg bg-blue-600/10 flex items-center
                        justify-center group-hover:bg-blue-600/10 transition-colors"
                    >
            ...
            <div>
                ...
                <div className="flex gap-3">
                    {socialLinks.map((link)=>{
                        ...
                        h-12 rounded-xl bg-white dark:bg-gray-800 flex items-center
