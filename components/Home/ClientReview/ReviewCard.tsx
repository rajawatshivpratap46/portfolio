...
const ReviewCard = ({user}:Props) => {
  return (
    <div className="bg-white shadow-md dark:bg-gray-800 rounded-lg m-3 p-6 relative">
        ...
        <p className="mt-6 text-blue text-gray-600 dark:text-gray-300 font-semibold">
            {user.review}
        </p>
        <div className="w-full h-[1.2px] bg-gray-300 dark:bg-gray-300 opacity-10 mt-6 mb-6"></div>
